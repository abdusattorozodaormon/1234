    ...
    for line in in_file.readlines():
        ...
        if len(test_line) == 0:
            ...
            if len(line) != 0 and line[len(line)-5:len(line)] == "NOEND":
                ...
                if len(line) != 0 and line[len(line)-1] not in ("(" , "{" , "}") and line[-4:] != 'else' :
                    line = line + ";"
...
if __name__ == '__main__':
    if len(sys.argv) != 2:
        print("usage: python3 python2java.py SCRIPT_TO_CONVERT.py")
        exit
